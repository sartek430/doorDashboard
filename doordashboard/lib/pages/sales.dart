    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          tempOrders = []; // Réinitialiser la liste temporaire à chaque fois que les données changent
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              final docRef = await FirebaseFirestore.instance.collection('sales').add({                  
                'status': status,
                'product': product,
                'nombreVendu': nombreVendu,
                'price': price,
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              final orderRef = firestore.collection('sales').doc(tempOrders[index].id);
